...
from entities.artikel_dakwah_mq_entity import ArtikelDakwahMqEntity, ProgramEntity, ContentEntity
from repositories.artikel_dakwah_mq_repository import ArtikelDakwahMqRepository

load_dotenv()

class ArtikelDakwahMqService:
    @staticmethod
    def scrape_data() -> ArtikelDakwahMqEntity:
        ...
        html_content = ArtikelDakwahMqRepository.get_mqfm_html(session, url)
